export function PhoneIcon(props) {
  return (
    <svg viewBox="0 0 24 24" width="18" height="18" fill="none" aria-hidden="true" {...props}>
      <path
        d="M4 5.5C4 4.67 4.67 4 5.5 4h2.14c.7 0 1.3.48 1.46 1.16l.9 3.6a1.5 1.5 0 0 1-.4 1.44l-1.4 1.4a12.5 12.5 0 0 0 5.7 5.7l1.4-1.4a1.5 1.5 0 0 1 1.44-.4l3.6.9c.68.16 1.16.76 1.16 1.46V20a1.5 1.5 0 0 1-1.5 1.5h-1.5C10.5 21.5 2.5 13.5 2.5 5.5V5.5"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
...
export function LeafIcon(props) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" aria-hidden="true" {...props}>
      <path
        d="M20 4C10 4 4 10 4 18c0 .6.4 1 1 1 8 0 14-6 15-16Z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
      <path d="M6 18c3-3 7-7 12-12" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  )
}

export function SodIcon(props) {
  return (
    <svg
      viewBox="0 0 16 16"
      width="16"
      ...
      {...props}
    >
      <rect x="1" y="9" width="14" height="4" rx="0.8" />
      <path d="M3 9V6M6 9V5M9 9V7M12 9V6" />
    </svg>
  )
}
...
export function GlobeIcon(props) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" aria-hidden="true" {...props}>
      ...
      <path
        d="M12 3.5c2.4 2.3 3.7 5.3 3.7 8.5s-1.3 6.2-3.7 8.5c-2.4-2.3-3.7-5.3-3.7-8.5S9.6 5.8 12 3.5ZM3.7 12h16.6"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
